<template>
  <div class="flex min-h-[720px]">
    <div class="flex flex-col w-[18rem]">
      <div class="flex flex-col px-[1.5rem] border-e border-gray-200 overflow-y-auto row-gap-2 flex-grow-1 ">
        <div class="flex items-center h-16">
          <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&amp;shade=600" alt="Your Company" class="w-9.5 h-8">
        </div>
        <nav class="flex-1 flex-col flex-grow-1">
          <ul role="list" class="">
            <li>
              <ul role="list" class="">
                <li>
                  ...
                  <a href="#" class="">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="w-[1.5rem] h-[1.5rem]">
                    ...
                    Dashboard
                    <span aria-hidden="true" class="">5</span>
                  </a>
                </li>
                <li>
                  <a href="#" class="">
                ...
                <li>
                  <a href="#" class="">
                    ...
                    Projects
                    <span aria-hidden="true" class="">12</span>
                  </a>
                </li>
                <li>
                  <a href="#" class="">
                    ...
                    Calendar
                    <span aria-hidden="true" class="">20+</span>
                  </a>
                </li>
                <li>
                  <a href="#" class="">
                ...
                <li>
                  <a href="#" class="">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="w-[1.5rem] h-[1.5rem]">
                      <path d="M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z" stroke-linecap="round" stroke-linejoin="round"></path>
                      <path d="M13.5 10.5H21A7.5 7.5 0 0 0 13.5 3v7.5Z" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                    Reports
                  </a>
                </li>
            ...
            <li>
              <div class="">Your teams</div>
              <ul role="list" class="">
                <li>
                  <!-- Current: "bg-gray-50 text-indigo-600", Default: "text-gray-700 hover:text-indigo-600 hover:bg-gray-50" -->
                  <a href="#" class="">
                    <span class="">H</span>
                    <span class="">Heroicons</span>
                  </a>
                </li>
                <li>
                  <a href="#" class="">
                    <span class="">T</span>
                    <span class="">Tailwind Labs</span>
                  </a>
                </li>
                <li>
                  <a href="#" class="">
                    <span class="">W</span>
                    <span class="">Workcation</span>
                  </a>
                </li>
              </ul>
            </li>
            <li class="">
              <a href="#" class="">
                <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=256&amp;h=256&amp;q=80" alt="" class=" w-[2rem] h-[2rem]">
